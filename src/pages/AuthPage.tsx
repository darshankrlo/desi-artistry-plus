...
export const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center bg-fixed" style={{ backgroundImage: `url(${loginBg})` }}>
      {/* Artistic Background Overlay */}
      <div className="min-h-screen bg-terracotta-dark/70 backdrop-blur-sm flex items-center justify-center p-4">
